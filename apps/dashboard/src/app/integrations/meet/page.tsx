    ...
    return (
      <div className="p-4">
        <div className="mb-4 flex items-center gap-2">
          <Video size={20} style={{ color: "#D94228" }} />
          <h1 className="text-lg font-bold text-gray-900">Pretive for Meet</h1>
        </div>
        <p className="mb-4 text-sm text-gray-500">
          Select a session for live presentation support during your meeting.
        </p>
        {sessions.length === 0 ? (
          <p className="text-sm text-gray-400">
            No ready sessions. Create one in the Pretive dashboard.
          </p>
        ) : (
    ...
    <div className="flex h-screen flex-col p-3">
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Video size={16} style={{ color: "#D94228" }} />
